public class MainEmployee {
    public static void main(String[] args) {
        ...
        System.out
                .println(john.getName() + ", you can retire in " + (Employee.MAX_AGE- john.getAge()) + " years.");
        System.out.println(lisa.getName() + ", you have been eligible to work for "
                + (lisa.getAge() - Employee.MIN_AGE) + " years.");
