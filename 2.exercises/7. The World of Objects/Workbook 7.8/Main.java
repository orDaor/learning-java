public class Main {
    ...
    public static void main(String[] args) {
        ...
        // new airline objects: contains [11] people
        Airline airline = new Airline();

        // populate with people
        for (int i = 0; i < airline.people.length; i++) {
            airline.people[i] = new Person(people[i]);
        }

        // print some of the people entered in the airline
